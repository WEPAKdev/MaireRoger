      ...
      <div class="panel">
        ...
        <div class="tab-content panel">
          ...
          <div class="tab-pane active" id="status">
            ...
            <!-- Change status form -->
            <form id="selectCommandeState" action="{$currentIndex|escape:'html':'UTF-8'}&amp;vieworder&amp;token={$smarty.get.token}" method="post" class="form-horizontal well hidden-print">
              <div class="row">
                <div class="col-lg-9">
